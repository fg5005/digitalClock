function getDigitalClock(hour, minute, second)
{
	 var r1 = "░", r2 = "█";	
   ...
   ["111","101","111","001","001"],["11","11","00","11","11"]];
  ...
  var result = "", enter = "\n";
	...
	for(var i = 0 ; i < 5 ; i++)
	{
       ...
       result += clock[minute[1]][i] + " " + clock[10][i] + " ";
       result += clock[second[0]][i] + " " + clock[second[1]][i] + enter;            
	}
